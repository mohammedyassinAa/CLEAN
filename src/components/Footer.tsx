      ...
      >
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-white text-center md:text-left">
            <p className="text-lg font-bold">Prêt pour un espace impeccable ?</p>
            <p className="text-white/80 text-sm">Contactez-nous dès aujourd&apos;hui pour un devis gratuit.</p>
          </div>
          <a
      ...
      <div className="container mx-auto px-4 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="lg:col-span-1">
          ...
          <div className="flex gap-3">
            {(siteConfig.social.instagram as string) !== "#" && (
